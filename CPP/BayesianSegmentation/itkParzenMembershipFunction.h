 ...
 *
 *=========================================================================*/
#ifndef __itkParzenMembershipFunction_h
#define __itkParzenMembershipFunction_h
...
protected:
  ParzenMembershipFunction(void);
  virtual ~ParzenMembershipFunction(void) {}
  void PrintSelf(std::ostream & os, Indent indent) const;

private:
  ParzenMembershipFunction(const Self &);   //purposely not implemented
...
#include "itkParzenMembershipFunction.hxx"
#endif
